...
const holder2 = document.querySelector('.snow2')
const holder3 = document.querySelector('.snow3')
const holder4 = document.querySelector('.snow4')
const holder5 = document.querySelector('.snow5')
const holder6 = document.querySelector('.snow6')
const holder7 = document.querySelector('.snow7')
const holder8 = document.querySelector('.snow8')
const holder9 = document.querySelector('.snow9')
const holder10 = document.querySelector('.snow10')
const holder11 = document.querySelector('.snow11')
const holder12 = document.querySelector('.snow12')
const count = parseInt(holder.getAttribute('count'))
const count2 = parseInt(holder2.getAttribute('count'))
...
const snow2 = new Shader(holder2, {
  depthTest: false,
  texture: snowflake,
  uniforms: {
    worldSize: { type: 'vec3', value: [0, 0, 0] },
  ...
  onResize(w, h, dpi) {
    ...
    Array.from({ length: w / h * count2 }, snowflake => {
...
const snow3 = new Shader(holder3, {
  depthTest: false,
  texture: snowflake,
  uniforms: {
    worldSize: { type: 'vec3', value: [0, 0, 0] },
...
const snow4 = new Shader(holder4, {
  depthTest: false,
  texture: snowflake,
  uniforms: {
    worldSize: { type: 'vec3', value: [0, 0, 0] },
...
const snow6 = new Shader(holder6, {
  depthTest: false,
  texture: snowflake,
  uniforms: {
    worldSize: { type: 'vec3', value: [0, 0, 0] },
...
const snow5 = new Shader(holder5, {
  depthTest: false,
  texture: snowflake,
  uniforms: {
    worldSize: { type: 'vec3', value: [0, 0, 0] },
...
const snow7 = new Shader(holder7, {
  depthTest: false,
  texture: snowflake,
  uniforms: {
    worldSize: { type: 'vec3', value: [0, 0, 0] },
...
const snow8 = new Shader(holder8, {
  depthTest: false,
  texture: snowflake,
  uniforms: {
    worldSize: { type: 'vec3', value: [0, 0, 0] },
...
const snow9 = new Shader(holder9, {
  depthTest: false,
  texture: snowflake,
  uniforms: {
    worldSize: { type: 'vec3', value: [0, 0, 0] },
...
const snow10 = new Shader(holder10, {
  depthTest: false,
  texture: snowflake,
  uniforms: {
    worldSize: { type: 'vec3', value: [0, 0, 0] },
...
const snow11 = new Shader(holder11, {
  depthTest: false,
  texture: snowflake,
  uniforms: {
    worldSize: { type: 'vec3', value: [0, 0, 0] },
...
const snow12 = new Shader(holder12, {
  depthTest: false,
  texture: snowflake,
  uniforms: {
    worldSize: { type: 'vec3', value: [0, 0, 0] },
